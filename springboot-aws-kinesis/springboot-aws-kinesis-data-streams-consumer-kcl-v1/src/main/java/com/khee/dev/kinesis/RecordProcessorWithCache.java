...
import com.khee.dev.service.CacheService;

@Component
public class RecordProcessorWithCache implements IRecordProcessor {
	private static final Logger log = LogManager.getLogger(RecordProcessorWithCache.class);
